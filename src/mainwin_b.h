...
class MainWinB : public AdvancedWidget<CudaFrame>
//class MainWin : public QMainWindow
{
	Q_OBJECT
public:
	MainWinB(bool onTop, bool asTool, PsiCon *, const char *name=0);
	~MainWinB();
...
private slots:
	...
	void actDoLogOn();
	void actDoLogOff();
	void actDoAccountModify();
	void actDoEditVCard();
	void actDoLinkHistory();
	void actDoLinkPassword();
	void actDoRegAim();
	void actDoRegMsn();
	void actDoRegYahoo();
	void actDoRegIcq();
...
public slots:
	...
	void searchCancel();
	void serv_search_results(const QList<SimpleSearch::Result> &list);
