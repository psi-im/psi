...
public:
     ...
     */
    QString timeString() const { return QString("%1:%2").arg(time_ / 60).arg(time_ % 60, 2, 10, QChar('0')); }
    ...
    bool isNull() const
    {
        return name_.isEmpty() && artist_.isEmpty() && album_.isEmpty() && track_.isEmpty() && url_.isEmpty()
            && time_ == 0;
    }
    ...
    {
        return name_ == t.name_ && artist_ == t.artist_ && album_ == t.album_ && track_ == t.track_ && url_ == t.url_
            && time_ == t.time_;
    }
     ...
     */
    bool operator!=(const Tune &t) const { return !((*this) == t); }
