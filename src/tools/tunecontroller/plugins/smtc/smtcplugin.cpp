...
class SMTCPlugin : public QObject, public TuneControllerPlugin {
...
QString SMTCPlugin::name() { return "SMTC"; }

TuneController *SMTCPlugin::createController() { return new SmtcTuneController(); }

#include "smtcplugin.moc"
