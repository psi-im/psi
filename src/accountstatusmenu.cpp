...
void AccountStatusMenu::chooseStatusActivated()
{
    ...
    connect(w, SIGNAL(set(const XMPP::Status &, bool, bool)), account,
...
void AccountStatusMenu::addIgnoreGlobalActions()
{
    ...
    blockAction->setToolTip(
        tr("Ignore all global actions for this account. For example, autostatus, mood, activity etc."));
