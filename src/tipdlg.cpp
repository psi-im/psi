    ...
    , psi_(psi)
{
    ...
    addTip( tr("Hello! Thank you for downloading Psi!\nWe hope that you will enjoy using it as we have enjoyed making it!\n"
           ...
           "<br><br>If you think, that you have found a bug or you just want to chat with other Psi users, then visit the <a href=\"https://forum.psi-plus.com/\">Psi Forums</a>.\n"
    ...
    addTip( tr("This is the last tip.\n<br><br>If you want to contribute your own \"tip of the day\", please publish it on the <a href=\"https://forum.psi-plus.com/\">Psi Forums</a> (or mail it to the one of the developers), and we'll be happy to integrate it for the next release."), "" );
