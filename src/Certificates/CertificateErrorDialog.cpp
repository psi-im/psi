...
CertificateErrorDialog::CertificateErrorDialog(const QString& title, const QString& host, const QCA::Certificate& cert,
                                               ...
                                               QString &tlsOverrideDomain, QByteArray &tlsOverrideCert, QWidget *parent)
: QDialog(parent),
  certificate_(cert),
  result_(result),
  validity_(validity),
  tlsOverrideDomain_(tlsOverrideDomain),
  tlsOverrideCert_(tlsOverrideCert),
  domainOverride_(domainOverride),
  host_(host)
{
    ...
    QPushButton *saveButton = new QPushButton(domainOverride.isEmpty() ? QObject::tr("&Trust this certificate")
                                                                       : QObject::tr("&Trust this domain"), this);
