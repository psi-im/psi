...
QWidget *OptionsTabStatus::widget()
{
	...
	QString s = tr("Makes the Barracuda client automatically set your status to \"away\" if your"
	...
	QWhatsThis::add(d->te_asMessage,
		tr("Specifies an extended message to use if you allow the Barracuda client"
