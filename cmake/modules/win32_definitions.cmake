...
if(WIN32)
    ...
    if(SDK_PATH AND (EXISTS "${SDK_PATH}"))
        ...
        elseif(MINGW)
            message(STATUS "Psi SDK_PATH is not configured; using CMake/package search paths for native MinGW dependencies")
        else()
            message(WARNING "Psi SDK not found at ${SDK_PATH}. Please set SDK_PATH variable or add Psi dependencies path to PATH system environment variable")
        endif()
    endif()
