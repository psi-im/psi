...
if(WIN32)
    ...
    if(SDK_PATH AND (EXISTS "${SDK_PATH}"))
        ...
        if(USE_MXE)
            if(USE_KEYCHAIN AND (EXISTS "${CMAKE_PREFIX_PATH}/lib/cmake/Qt${QT_DEFAULT_MAJOR_VERSION}Keychain"))
                set(Qt${QT_DEFAULT_MAJOR_VERSION}Keychain_DIR "${CMAKE_PREFIX_PATH}/lib/cmake/Qt${QT_DEFAULT_MAJOR_VERSION}Keychain" CACHE STRING "Path to Qt${QT_DEFAULT_MAJOR_VERSION}Keychain cmake files")
            endif()
        else()
